...
final class MiniZincChallenges extends ZincBasedTest {
    ...
    def connect_0018(): Unit = {
        // The solution cannot be verified due to a model issue, see https://github.com/minizinc/libminizinc/issues/709.
    ...
    @Tag(HasCountConstraint)
    @Tag(HasMaximumConstraint)
    @Tag(HasNetworkFlowCostConstraint)
