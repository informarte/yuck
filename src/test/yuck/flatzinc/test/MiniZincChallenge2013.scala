...
final class MiniZincChallenge2013 extends MiniZincBasedTest {
    ...
    @Test
    @Category(Array(classOf[MinimizationProblem], classOf[HasCountConstraint]))
    def on_call_rostering_10s_150d: Unit = {
