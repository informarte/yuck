...
final class MiniZincChallenge2018 extends MiniZincBasedTest {
    ...
    def gfd_schedule_n65f2d50m20k10: Unit = {
    ...
    def largescheduling_instance_0100_4: Unit = {
    ...
    def opt_cryptanalysis_r10: Unit = {
