...
final class MiniZincChallenge2012 extends MiniZincBasedTest {
    ...
    def pattern_set_mining_k1_ionosphere: Unit = {
    ...
    @Test
    @Category(Array(classOf[MinimizationProblem]))
    def project_planning_12_8: Unit = {
